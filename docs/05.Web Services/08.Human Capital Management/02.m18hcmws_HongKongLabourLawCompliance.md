...
meta:
  - name: description
    content: Learning in Hong Kong Labour Law Compliance for HRMS /HRIS. Browse reference, sample code, tutorials, and more.
  - name: keywords
    content: Hong Kong Labour Law Compliance, HRMS, HRIS, HCM, HR system, HR software
---
